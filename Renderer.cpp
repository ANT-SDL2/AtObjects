...
namespace AtObjects {
    namespace Renderer {
        ...
        void Render(Texture *Texture, float TargetX, float TargetY, float TargetWidth, float TargetHeight, int TargetTile, float ClipWidth, float ClipHeight, float ClipX, float ClipY) {
            if (Texture) {
        ...
        void RenderArea(Texture *Texture, std::vector< std::vector<int> > &TileMap, float TargetX, float TargetY, float TargetWidth, float TargetHeight) {
            if (Texture) {
        ...
        void RenderDialog(Texture *Texture, float TargetX, float TargetY, float TargetWidth, float TargetHeight) {
            if (Texture) {
                float TileWidth = Texture->GetWidth();
                float TileHeight = Texture->GetHeight();
        ...
        void RenderTexture(Texture *Texture, float TargetX, float TargetY, float TargetWidth, float TargetHeight, int TargetTile, float ClipWidth, float ClipHeight, float ClipX, float ClipY) {
            if (Texture) {
                GLuint GLTexture = Texture->GetGLTexture();
                glBindTexture(GL_TEXTURE_2D, GLTexture);
                Render(Texture, TargetX, TargetY, TargetWidth, TargetHeight, TargetTile, ClipWidth, ClipHeight, ClipX, ClipY);
                glBindTexture(GL_TEXTURE_2D, 0);
            }
        }
