...
namespace AtObjects {
    ...
    bool DiskInRectangle(float X1, float Y1, float R1, float r1, float Angle1, float Direction1, float X2, float Y2, int Width2, int Height2, float Direction2, float &AdjustX, float &AdjustY) {
        ...
        if (Overlap >= 0) {
            ...
            if (InnerR) {
                ...
                int Maximum = AtTools::Vectors::FindMaximum(DistancesSq);
    ...
    bool DetectCollisionBetween(Object *Object1, Object *Object2, int &Axis, float &AdjustX, float &AdjustY, float Interpolation) {
        ...
        if (Object1 != Object2) {
            Interactable *Interactable1 = Object1->GetInteractable();
            Interactable *Interactable2 = Object2->GetInteractable();
            int Shape1 = Interactable1->Shape;
            int Shape2 = Interactable2->Shape;
            if (Shape1 == Shapes::Rectangle) {
                float X1 = Object1->X(Interpolation, Reference::Collision), Y1 = Object1->Y(Interpolation, Reference::Collision);
                float Width1 = Object1->CollisionWidth(), Height1 = Object1->CollisionHeight();
                float Direction1 = Object1->GetDirection();

                if (Shape2 == Shapes::Rectangle) {
                    float X2 = Object2->X(Interpolation, Reference::Collision), Y2 = Object2->Y(Interpolation, Reference::Collision);
                    float Width2 = Object2->CollisionWidth(), Height2 = Object2->CollisionHeight();
                    float Direction2 = Object2->GetDirection();

                    Collision = RectangleInRectangle(X1, Y1, Width1, Height1, Direction1, X2, Y2, Width2, Height2, Direction2, AdjustX, AdjustY);
                } else if (Shape2 == Shapes::Disk) {
                    float X2 = Object2->X(Interpolation, Reference::Origin, Position::Center), Y2 = Object2->Y(Interpolation, Reference::Origin, Position::Center);
                    float R2 = Object2->CollisionWidth()/2.f;
                    float r2 = Object2->CollisionHeight()/2.f;
                    float Angle2 = Interactable2->Section()*2.f*M_PI;
                    float Direction2 = Object2->GetDirection();

                    Collision = DiskInRectangle(X2, Y2, R2, r2, Angle2, Direction2, X1, Y1, Width1, Height1, Direction1, AdjustX, AdjustY);
                    //if (Object2->GetName() == "Neotms" && Object1->GetName() == "AreaCollision") std::cout << AdjustX << " " << AdjustY << std::endl;
                }
            } else if (Shape1 == Shapes::Disk) {
                float X1 = Object1->X(Interpolation, Reference::Origin, Position::Center), Y1 = Object1->Y(Interpolation, Reference::Origin, Position::Center);
                float R1 = Object1->CollisionWidth()/2.f;
                float r1 = Object1->CollisionHeight()/2.f;
                float Angle1 = Interactable1->Section()*2.f*M_PI;
                float Direction1 = Object1->GetDirection();
                ...
                if (Shape2 == Shapes::Rectangle) {
                    ...
                    Collision = DiskInRectangle(X1, Y1, R1, r1, Angle1, Direction1, X2, Y2, Width2, Height2, Direction2, AdjustX, AdjustY);
                    //if (Object1->GetName() == "Neotms" && Object2->GetName() == "AreaCollision") std::cout << AdjustX << " " << AdjustY << std::endl;
                } else if (Shape2 == Shapes::Disk) {
                    float X2 = Object2->X(Interpolation, Reference::Origin, Position::Center), Y2 = Object2->Y(Interpolation, Reference::Origin, Position::Center);
                    float R2 = Object2->CollisionWidth()/2.f;
                    float r2 = Object2->CollisionHeight()/2.f;
                    ...
                    Collision = DiskInDisk(X1, Y1, R1, r1, Angle1, Direction1, X2, Y2, R2, r2, Angle2, Direction2, AdjustX, AdjustY);
                }
            }

            if (!Interactable1->IsCollidable() || !Interactable2->IsCollidable()) {
                AdjustX = AdjustY = 0;
            }
            ...
            if (Shape1 == Shapes::Disk && Shape2 == Shapes::Disk) {
                if (fabs(AdjustX) > fabs(AdjustY)) {
                    ...
                    Vector2 Vector = Vector2(Object1->X()-Object2->X(), Object1->Y()-Object2->Y());
        ...
        if (Direction1 || Direction2) {
            ...
            if (Distance <= (Diagonal1+Diagonal2)/4.f) {
                ...
                while (Overlap and i<Axes.size()) {
                    ...
                    int Minimum1 = AtTools::Vectors::FindMinimum(Scalar1);
                    int Maximum1 = AtTools::Vectors::FindMaximum(Scalar1);
                    int Minimum2 = AtTools::Vectors::FindMinimum(Scalar2);
                    int Maximum2 = AtTools::Vectors::FindMaximum(Scalar2);
